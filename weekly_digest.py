...
WEEKLY_BRIEF = (
    "수도권 물류 신규 공급이 10년 내 최저 수준으로 줄었습니다. 상온 공실률은 12%대로 안정되는 반면 저온은 33%대로 부담이 남아, 자산별 온도차가 뚜렷합니다. 투자 심리는 회복 국면으로 돌아섰고 거래 규모도 전년 대비 16.8% 늘어난 5.7조 원을 기록했습니다. 공급이 끊긴 지금, 입지·스펙을 갖춘 기존 상온 자산의 희소가치가 부각되는 시점입니다."
)
