...
WEEKLY_BRIEF = (
    "올해 수도권 물류시장의 핵심은 '공급 절벽'입니다. 경기도 조례 강화로 대형 물류센터 신규 공급이 사실상 막히면서 이미 지어진 우량 자산의 희소가치가 오르고 있습니다. A급 공실률은 17%로 전년 대비 6%p 내렸고 상온 임대료는 오름세로 돌아섰습니다. 
    상온은 회복이 뚜렷한 반면 저온은 아직 공실 부담이 남아 온도차가 큽니다. 보유 자산의 매각·임대 전략을 지금 점검해 두는 것이 유리한 시점입니다."
)
