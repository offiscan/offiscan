...
WEEKLY_BRIEF = (
    "2026년 상반기 수도권 물류센터 신규 공급은 17.5만 평에 그쳐 전년 동기의 3분의 1 수준으로 급감했고, 상반기 개발 허가는 단 3건에 불과했습니다. 공실률은 상온 12.3%, 저온 33.7%로 각각 1.0%p·2.6%p 낮아지며 2024년 정점 이후 하락세를 이었지만, 저온은 여전히 상온의 약 2.7배로 온도차가 뚜렷합니다. 임대료마저 상온·저온 모두 반등해 하락세가 멈춘 지금, 공급이 끊긴 시장에서 입지·스펙을 갖춘 우량 상온 자산의 희소가치가 부각되는 국면입니다."
)
