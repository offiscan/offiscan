...
WEEKLY_BRIEF = (
    "9월 들어 물류업계 소식을 보면, 쿠팡이 쓰는 핵심 물류센터가 자금 재조달(리파이낸싱)에 성공하며 <임차가 탄탄한 창고엔 지금도 돈이 붙는다>는 걸 다시 보여줬습니다. 반면 주요 물류기업들의 상반기 실적은 '매출은 늘었는데 이익은 줄었다'로 요약돼, 현장에선 비용 부담이 커지고 있습니다. 좋은 자산과 그렇지 않은 자산의 격차가 벌어지는, 이른바 '될 곳만 되는' 시장 흐름이 이어지고 있습니다."
)
