...
WEEKLY_BRIEF = (
    "이번 주 안성에서는 산업단지·물류창고 인허가를 둘러싼 30억대 뇌물 사건으로 공무원 등 10명이 기소됐습니다. 인허가 문턱이 실제로 얼마나 높고 민감한 관문인지 보여주는 사례로, 최근 수도권 물류센터 공급이 급감한 배경과 무관하지 않습니다. 한편 삼성증권·코람코는 공급절벽 속에서도 안양 도심형 물류센터 인수를 추진하며, 신규 공급이 끊긴 시장에서 입지를 갖춘 기존 우량자산으로 자금이 몰리는 흐름을 다시 확인시켰습니다."
)
