...
WEEKLY_BRIEF = (
    "안성·이천·평택·여주·호법 권역에서 펀드 만기 물량 대거 출회했습니다. 안성 대덕물류센터·평택 진위 물류센터는 우선협상대상자 선정, 로지스포인트 호법A는 매각 완료되었으며 저온은 여전히 매각난을 겪고 있습니다. 상온 물류센터는 공실률 하락·임대료 상승으로 회복세지만, 저온 물류센터는 높은 공실 부담이 지속되고 있습니다."
)
